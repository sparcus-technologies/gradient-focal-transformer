...
# Create resnet18 model - COCO has 80 classes
model = create_model('resnet18', pretrained=True, num_classes=80)
...
for epoch in range(num_epochs):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), 'best_coco_resnet18.pth')

# Load best model and evaluate on validation set (as test set)
model.load_state_dict(torch.load('best_coco_resnet18.pth'))
