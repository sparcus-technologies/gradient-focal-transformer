...
# Create resnet50 model - using the original dataset's classes
model = create_model('resnet50', pretrained=True, num_classes=101)
...
for epoch in range(num_epochs):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), 'best_food_r50.pth')

# Load best model and evaluate on test set
model.load_state_dict(torch.load('best_food_r50.pth'))
